@extends('admin.layouts.master') @section('title', 'tiến độ')
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Tạo mới tiến độ</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12">
						<div class="dataTable_wrapper">
							{{ Form::open(array('url' => 'admin/progress/store')) }}
							<div class="form-group">{{ Form::label('main_project_id', 'Dự án') }}
								{{ Form::select('main_project_id', $projects,null, ['class' =>
								'form-control']) }}</div>
							...
							<div class="form-group">{{ Form::label('meta_description', 'Mô tả
								Meta') }} {{ Form::text('meta_description',
								Input::old('meta_description'), array('class' =>
								'form-control')) }}</div>
							{{ Form::submit('Create the progress!', array('class' => 'btn
...
<script type="text/javascript">
				...
				$('#project_id').change(function() {
					var url = "/admin/progress/checkProject";
					projectId = $(this).val();
                    $.ajax({
                        url : url,
                        type : 'Post',
...
//                	                            window.location.href = '{{ URL::route('admin.main_project.index') }}';
                            		...
                            		window.location.href = '/admin/progress/'+ data.progressId+'/edit';
                            	}
