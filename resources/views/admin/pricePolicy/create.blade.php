@extends('admin.layouts.master') @section('title', 'Bảng giá và Chính sách')
...
<div class="row">
	<div class="col-lg-12 text-right">
		<a href="/admin/pricePolicy/create" class="btn btn-success"><i
			class="fa fa-plus-circle"></i> Tạo Bảng giá và Chính sách cho dự án</a>
	</div>
</div>
<br />
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Tạo mới Bảng giá và Chính sách</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12">
						<div class="dataTable_wrapper">
							{{ Form::open(array('url' => 'admin/pricePolicy/store')) }}
							...
							<div class="form-group">{{ Form::label('meta_description', 'Mô tả
								...
								'form-control')) }}</div>
							{{ Form::submit('Create the pricePolicy!', array('class' => 'btn
