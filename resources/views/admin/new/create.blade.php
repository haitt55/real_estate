@extends('admin.layouts.master') @section('title', 'Tin Tức')
...
<div class="row">
	<div class="col-lg-12 text-right">
		<a href="/admin/new/create" class="btn btn-success"><i
			class="fa fa-plus-circle"></i> Tạo Tin Tức cho dự án</a>
	</div>
</div>
<br />
<div class="row">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="dataTable_wrapper">
							{{ Form::open(array('url' => 'admin/new/store', 'enctype' => "multipart/form-data")) }}
							...
							<div class="form-group">
                                ...
                                <div class="row" style="margin-top: 10px;">
                                    <div class="display-image col-md-12">
                                        <img class="thumbnail" style="max-width: 200px;" id="image_header_preview" src="" alt="">
                                    </div>
                                </div>
                            </div>
							...
							{{ Form::submit('Create the new!', array('class' => 'btn
